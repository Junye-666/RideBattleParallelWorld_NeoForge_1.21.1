...
public class TitanSwordItem extends RiderWeaponItem {
    public TitanSwordItem(Properties properties) {
        super(RideBattleParallelWorlds.MODID, "kuuga", "titan_sword", properties.stacksTo(1).durability(0));
    }

    @Override
    protected ResourceLocation requiredForm() {
        return KuugaConfig.TITAN_ID;
    }

    @Override
    protected ResourceLocation skill() {
        return RiderSkills.CALAMITY_TITAN;
    }
