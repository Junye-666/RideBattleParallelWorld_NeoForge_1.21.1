package com.jpigeon.ridebattleparallelworlds.common.rider.decade.entity;
...
public class DecadeHenshinEffect extends AbstractOwnerFollowEffect {
    ...
    protected void registerAnimationControllers(AnimatableManager.ControllerRegistrar registrar) {
        addController(registrar, "decade_henshin_controller", createHoldController("decade_henshin"));
    }
