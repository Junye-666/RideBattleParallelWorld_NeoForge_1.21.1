...
import com.jpigeon.ridebattleparallelworlds.client.anim.rider.KuugaAnimations;
import com.jpigeon.ridebattleparallelworlds.client.handler.SkillMovementUtils;
...
public final class KuugaClientHandler implements IRiderClientHandler {
    ...
    private static void deplaceKuuga(LocalPlayer player, ResourceLocation skillId) {
    ...
    private static void animateKuuga(LocalPlayer player, ResourceLocation skillId) {
    ...
    private static boolean isKuugaKick(ResourceLocation skillId) {
