package com.jpigeon.ridebattleparallelworlds.client.event;
...
public class ClientModEvents {
    ...
    static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(
                ...
                context -> GeoRenderRegistryUtil.createEffectRenderer(context, RideBattleParallelWorlds.MODID, "mirror", "ryuki_henshin_effect")
        );
        event.registerBlockEntityRenderer(
                ModBlockEntities.KUUGA_COFFIN_BE.get(),
                context -> GeoRenderRegistryUtil.createBlockRenderer(RideBattleParallelWorlds.MODID, "kuuga", "kuuga_coffin")
        );
    }
}
