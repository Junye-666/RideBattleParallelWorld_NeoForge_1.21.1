...
public class ModItems {
    ...
    public static final DeferredItem<Item> WORLDS_FRAGMENT = ITEMS.register("decade/worlds_fragment", ()
            -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> KAMEN_RIDE_DECADE = ITEMS.register("decade/cards/kamen_ride_decade_card", ()
            -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> KAMEN_RIDE_KUUGA = ITEMS.register("decade/cards/kamen_ride_kuuga_card", ()
            -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> FORM_RIDE_KUUGA_DRAGON = ITEMS.register("decade/cards/form_ride_kuuga_dragon_card", ()
            -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> FORM_RIDE_KUUGA_PEGASUS = ITEMS.register("decade/cards/form_ride_kuuga_pegasus_card", ()
            -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> FORM_RIDE_KUUGA_TITAN = ITEMS.register("decade/cards/form_ride_kuuga_titan_card", ()
            -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<PegasusBowgunItem> PEGASUS_BOWGUN = ITEMS.register("kuuga/weapon/kuuga_pegasus_bowgun", ()
            -> new PegasusBowgunItem(new Item.Properties().rarity(Rarity.RARE)));
    public static final DeferredItem<TitanSwordItem> TITAN_SWORD = ITEMS.register("kuuga/weapon/kuuga_titan_sword", ()
            -> new TitanSwordItem(new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 6, 0)).rarity(Rarity.RARE)));
    public static final DeferredItem<RisingDragonRodItem> RISING_DRAGON_ROD = ITEMS.register("kuuga/weapon/kuuga_rising_dragon_rod", ()
            -> new RisingDragonRodItem(new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 4, -2)).rarity(Rarity.EPIC)));
    public static final DeferredItem<RisingPegasusBowgunItem> RISING_PEGASUS_BOWGUN = ITEMS.register("kuuga/weapon/kuuga_rising_pegasus_bowgun", ()
            -> new RisingPegasusBowgunItem(new Item.Properties().rarity(Rarity.EPIC)));
    public static final DeferredItem<RisingTitanSwordItem> RISING_TITAN_SWORD = ITEMS.register("kuuga/weapon/kuuga_rising_titan_sword", ()
            -> new RisingTitanSwordItem(new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 6, 0)).rarity((Rarity.EPIC))));

    // Decade
    // 盔甲
    public static final DeferredItem<DecaDriverItem> DECA_DRIVER = ITEMS.register("decade/deca_driver", ()
            -> new DecaDriverItem(PWArmorMaterial.DECADE_MATERIAL, DecaDriverItem.Type.LEGGINGS, new Item.Properties()));

    public static final DeferredItem<DecadeBaseArmorItem> DECADE_HELMET = ITEMS.register("decade/armor/decade_base_helmet", ()
            -> new DecadeBaseArmorItem(PWArmorMaterial.DECADE_MATERIAL, DecadeBaseArmorItem.Type.HELMET, new Item.Properties()));
    public static final DeferredItem<DecadeBaseArmorItem> DECADE_CHESTPLATE = ITEMS.register("decade/armor/decade_base_chestplate", ()
            -> new DecadeBaseArmorItem(PWArmorMaterial.DECADE_MATERIAL, DecadeBaseArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final DeferredItem<DecadeBaseArmorItem> DECADE_BOOTS = ITEMS.register("decade/armor/decade_base_boots", ()
