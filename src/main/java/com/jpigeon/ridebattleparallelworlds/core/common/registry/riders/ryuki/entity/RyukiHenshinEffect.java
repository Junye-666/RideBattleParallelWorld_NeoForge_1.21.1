...
public class RyukiHenshinEffect extends BaseRiderEffectEntity {
    private static final int MAX_LIFETIME = 15;
    private int lifetime = 0;
    private static final EntityDataAccessor<Optional<UUID>> OWNER_UUID = SynchedEntityData.defineId(RyukiHenshinEffect.class, EntityDataSerializers.OPTIONAL_UUID);


    public RyukiHenshinEffect(EntityType<RyukiHenshinEffect> type, Level level) {
        super(type, level, RideBattleParallelWorlds.MODID, "ryuki", "ryuki_henshin_effect");
    }
